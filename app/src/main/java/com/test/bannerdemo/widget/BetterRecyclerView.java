...
/**
 * 解决RecyclerView嵌套横向滑动RecyclerView时横向滑动不灵敏的问题
 * Created by wanghongjia on 2018/5/10.
 */
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (getScrollState() != SCROLL_STATE_DRAGGING) {
                    ...
                    if (canScrollHorizontally && Math.abs(dx) > mTouchSlop && (Math.abs(dx) >= 0 || canScrollVertically)) {
                        startScroll = true;
                    }
